...
def generate_card_image(text):
    ...
    quote_offset = 30
    sep_y = CARD_PADDING_Y + quote_offset + text_block_height + 20
    footer_height = 40
    MIN_CARD_HEIGHT = 400
    card_height = max(MIN_CARD_HEIGHT, CARD_PADDING_Y + quote_offset + text_block_height + footer_height + CARD_PADDING_Y)
    ...
    footer_main = "generated by @unsrifess on X \u00b7"
    footer_link = CARD_FOOTER_LINK
    footer_full = f"{footer_main} {footer_link}"
